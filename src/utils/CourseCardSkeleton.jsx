const CourseCardSkeleton = () => {
    return (
      <div role="status" className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-3 sm:p-4 animate-pulse">
        <div className="flex items-center justify-center h-36 sm:h-48 mb-3 sm:mb-4 bg-gray-300 rounded-md dark:bg-gray-700">
