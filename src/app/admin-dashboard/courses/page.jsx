    ...
    <div className="p-4 sm:p-6 dark:bg-gray-900">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <div className="grid grid-cols-[2fr_1.5fr_0.8fr_1.5fr_1fr_0.5fr] p-3 sm:p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
          ...
          <h2 className="font-semibold text-gray-700 dark:text-gray-200 text-sm sm:text-base hidden md:block">
            Tags
          </h2>
          <h2 className="font-semibold text-gray-700 dark:text-gray-200 text-sm sm:text-base hidden md:block">
            Level
        ...
        <div className="divide-y divide-gray-100 dark:divide-gray-700">
          {courses?.map((course) => (
            <div
              key={course._id}
              className="grid grid-cols-[2fr_1.5fr_0.8fr_1.5fr_1fr_0.5fr] p-3 sm:p-4 items-center"
            >
      ...
      {/* {isEditModalOpen && <EditCourseModal  setIsEditModalOpen={setIsEditModalOpen} courseId={courseId}/>} */}
      {isEditModalOpen && (
        <EditCourseModal
